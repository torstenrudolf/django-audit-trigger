    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('db_relid', audit.models.audit_log.OIDField(db_index=True, help_text=b'the object ID of the table that caused the trigger invocation')),
                ('db_session_user_name', models.TextField()),
                ('db_current_timestamp', models.DateTimeField(help_text=b'Start of db transaction')),
                ('db_statement_timestamp', models.DateTimeField(db_index=True, help_text=b'Start of sql statement')),
                ('db_clock_timestamp', models.DateTimeField(help_text=b'Actual time when the trigger was run')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('log_query_text', models.BooleanField(default=False, verbose_name=b'Do you want to log the whole text of the sql query?')),
